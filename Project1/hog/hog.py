...
def is_swap(player_score, opponent_score):
    ...
    if absolute_diff == opponent_score // 10 % 10:
        return True
    return False
    # END PROBLEM 4
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        ...
        diff_value = num_roll0 - turn_value
        turn_value = take_turn(num_roll0, score1, dice)
        score0 += turn_value
        if feral_hogs:
            if abs(diff_value) == 2:
                score0 += 3
        ...
        diff_value1 = num_roll1 - turn_value1
        turn_value1 = take_turn(num_roll1, score0, dice)
        score1 += turn_value1
        if feral_hogs:
            if abs(diff_value1) == 2:
                score1 += 3
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    while 11-num_roll:
        ...
        if average_value > score_high:
            score_high = average_value
            num_roll_value = num_roll
        num_roll += 1
    return num_roll_value
    # END PROBLEM 9
...
def bacon_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 10
    turn_value = free_bacon(opponent_score)
...
def swap_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 11
    score_value = free_bacon(opponent_score)
    score += score_value
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    Using which one or which severals strategy is more probably win?
    free_bacon, swap, num_rolls, ferals, max_scoring_num_rolls
    """
    # BEGIN PROBLEM 12
    if score < opponent_score:
